...
async function renderPage10() {
  ...
  fs.writeFileSync('storage/page10_highres.png', imgBuf);
  console.log('Saved storage/page10_highres.png successfully!');
}

renderPage10().catch(console.error);
